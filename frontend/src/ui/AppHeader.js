...
export default function AppHeader({ navigation, isLogged }) {
  ...
  return (
    <View style={{
      ...
      <View style={{
        width: "100%",
        maxWidth: 1280,                 // ⬅️ wider on desktop
        ...
        {/* Nav: scrollable on tiny screens */}
  ...
  return (
    <TouchableOpacity
      ...
      style={{
        ...
        gap: 6,
        borderRadius: 999,
        paddingVertical: compact ? 6 : 8,       // ⬅️ smaller on mobile
    ...
    >
      ...
      <Text style={{ color: primary ? "#000" : "#eaeaea", fontWeight: "700", fontSize: compact ? 12 : 13 }}>
        {label}
      </Text>
    </TouchableOpacity>
  );
